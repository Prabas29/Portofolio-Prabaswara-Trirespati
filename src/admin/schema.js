...
export const SECTION_SCHEMAS = {
  ...
  about: {
    ...
    fields: [
      { key: 'photo', label: 'Foto profil', type: 'image', shared: true },
      { key: 'photoCaption', label: 'Keterangan foto', shared: true },
      { key: 'photoLocation', label: 'Lokasi (kanan bawah foto)', shared: true },
    ],
  },
  ...
  competencies: {
    ...
    repeater: {
      ...
      fields: [
        ...
        { key: 'title', label: 'Judul', shared: true },
  ...
  education: {
    ...
    repeater: {
      ...
      fields: [
        ...
        { key: 'school', label: 'Institusi', shared: true },
        { key: 'degree', label: 'Jurusan / program' },
        { key: 'logo', label: 'Logo', type: 'image', shared: true },
  ...
  experience: {
    ...
    repeater: {
      ...
      fields: [
        ...
        { key: 'role', label: 'Posisi', shared: true },
        { key: 'org', label: 'Perusahaan / organisasi', shared: true },
        { key: 'logo', label: 'Logo', type: 'image', shared: true },
  ...
  projects: {
    ...
    repeater: {
      ...
      titleKey: 'title',
      fields: [
        { key: 'index', label: 'Label kategori (mis. 01 / DATA ANALYTICS)', shared: true },
        { key: 'title', label: 'Nama proyek', shared: true },
        { key: 'body', label: 'Deskripsi', type: 'textarea' },
        { key: 'stack', label: 'Teknologi', type: 'list', shared: true },
        { key: 'href', label: 'Link proyek', shared: true },
      ],
    },
  },
  ...
  skills: {
    ...
    repeater: {
      ...
      fields: [
        ...
        { key: 'items', label: 'Daftar keahlian', type: 'list', shared: true },
      ],
    },
  },
  ...
  certifications: {
    ...
    repeater: {
      ...
      titleKey: 'name',
      fields: [
        { key: 'name', label: 'Nama sertifikat', shared: true },
        { key: 'issuer', label: 'Penerbit', shared: true },
        { key: 'year', label: 'Tahun', shared: true },
        { key: 'image', label: 'Gambar sertifikat', type: 'image', shared: true },
      ],
    },
  },
  ...
  contact: {
    ...
    repeater: {
      ...
      fields: [
        ...
        { key: 'value', label: 'Yang ditampilkan', shared: true },
        { key: 'href', label: 'Link (mailto: / tel: / https:)', shared: true },
      ],
    },
  },
